...
nested_df %>% 
  ...
  ggtitle(paste('The mean of the ipw estimator (wrongly specified) is ', round(mean_ipw_estimator_w, 2))) + 
  geom_point(color = 'blue') +
  geom_hline(yintercept = 10) +
  theme_bw()
```
...
nested_df %>% 
  ...
  ggtitle(paste('The mean of the model estimate is ', round(mean_model_estimator_w, 2))) + 
  geom_point(color = 'blue') +
  geom_hline(yintercept = 10) +
  theme_bw()
```

We also overestimated the true ACE (10) if our REG model is misspecified.
